...
| :--------------- | :------- | :------------------- |
| [Продуктовая аналитика интернет магазина спортивных товаров]() | Анализ эффективности добавления баннера на главную страницу сайта. Анализ портрета пользователя. | Python, Pandas, NumPy, Matplotlib, Plotly ,Seaborn, |
